...
├── parser/        generated by ANTLR from the committed WebIDL.g4
...
└── kotlin/        FrontendTest · PassesTest · GoldenTest · PluginFunctionalTest (TestKit)
```
...
│                 StagingFloat32 · StagingUint32 (reused typed arrays)
├── context/      GpuContext · requestContext() (null = no WebGPU) · GpuFeatures
│                 DeviceLossWatcher · ErrorScopes
├── resource/     GpuBuffer · GpuTexture (AutoCloseable) · ResourceScope
├── shader/       ShaderLibrary (loads .wgsl) · compile diagnostics (line/column messages)
└── layout/       UniformWriter · WGSL alignment helpers (later generated, see PLAN Phase 8)
```
